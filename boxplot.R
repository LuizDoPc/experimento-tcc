library(tidyverse)
library(readr)
javagrpc_pequeno <- read_csv("dados/pequeno/javagrpc-pequeno.csv")
javahttp_pequeno <- read_csv("dados/pequeno/javahttp-pequeno.csv")
gohttp_pequeno <- read_csv("dados/pequeno/gohttp-pequeno.csv")
gogrpc_pequeno <- read_csv("dados/pequeno/gogrpc-pequeno.csv")
